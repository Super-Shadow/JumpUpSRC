...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if((downLeftRay.collider != null && !downLeftRay.collider.CompareTag("Slide")) || (downRightRay.collider != null && !downRightRay.collider.CompareTag("Slide")))
		{
        ...
        if(!grounded)
		{
            if((upLeftRay.collider != null && upLeftRay.collider.CompareTag("Slide") ||
                upRightRay.collider != null && upRightRay.collider.CompareTag("Slide") || 
                leftDownRay.collider != null && leftDownRay.collider.CompareTag("Slide") ||
                leftUpRay.collider != null && leftUpRay.collider.CompareTag("Slide") || 
                rightDownRay.collider != null && rightDownRay.collider.CompareTag("Slide") ||
                rightUpRay.collider != null && rightUpRay.collider.CompareTag("Slide") ||
                downLeftRay.collider != null && downLeftRay.collider.CompareTag("Slide") ||
                downRightRay.collider != null && downRightRay.collider.CompareTag("Slide")))
			{
                boxCollider.sharedMaterial = slidePhysMat;
			}
            else if(upLeftRay.collider != null ||
                    upRightRay.collider != null ||
                    leftDownRay.collider != null || 
                    leftUpRay.collider != null ||
                    rightDownRay.collider != null ||
                    rightUpRay.collider != null ||
                    downLeftRay.collider != null || 
                    downRightRay.collider != null )
			{
